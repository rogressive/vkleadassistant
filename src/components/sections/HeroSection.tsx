...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-[110vh] flex items-center pt-24 pb-20 overflow-hidden">
      {/* Dark gradient background with neon accents */}
      <div className="absolute inset-0" style={{ background: 'var(--gradient-hero)' }} />
      
      {/* Animated neon gradient blobs */}
      <div className="absolute top-10 -left-40 w-[600px] h-[600px] bg-primary/20 blob blob-1" />
      <div className="absolute top-40 -right-20 w-[700px] h-[700px] bg-neon-pink/15 blob blob-2" />
      <div className="absolute -bottom-40 left-1/4 w-[500px] h-[500px] bg-neon-green/10 blob blob-3" />
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <h1 className={`text-5xl sm:text-6xl md:text-7xl lg:text-[90px] font-display font-black mb-8 tracking-tight leading-[0.95] transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '100ms' }}>
